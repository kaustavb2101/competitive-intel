...
phase_check(){
  ...
  elif [ "$rc" -eq 3 ]; then skip "build_flood_hazard.py --check (source-data/gistda_flood_hazard.json absent — GISTDA pull, not committed)"
  else bad "build_flood_hazard.py --check (flood_hazard.json drifted from source-data/gistda_flood_hazard.json/amphoe.json)"
  fi
